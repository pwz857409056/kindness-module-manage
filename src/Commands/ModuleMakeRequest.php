...
class ModuleMakeRequest extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        with(new StubGenerator($moduleName, $this))
            ...
            ->generatorStub('requests/base.stub', $filepath);
    ...
    {
        return Config::get('plugin.kindness.module-manage.app.paths.generator.request');
    }

...
use Kindness\ModuleManage\Concerns\Command\InteractsWithModule;
...
class ModuleMakeService extends Command
{
    ...
    protected static $defaultName = 'module:make-service';
    protected static $defaultDescription = '生成一个service文件';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        with(new StubGenerator($moduleName, $this))
            ...
            ->generatorStub('service/base.stub', $filepath);
    ...
    {
        return Config::get('plugin.kindness.module-manage.app.paths.generator.service');
    }
    ...
    protected function getNamespace()
    {
        ...
        $namespaceArr = array_merge([
            Config::get('plugin.kindness.module-manage.app.namespace'),

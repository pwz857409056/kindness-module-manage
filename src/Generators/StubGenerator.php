...
class StubGenerator extends Generator
{
    ...
    {
        $stubPaths = Config::get('plugin.kindness.module-manage.app.paths.stub', []);
    ...
    {
        return Config::get('plugin.kindness.module-manage.app.paths.stub_path') . DIRECTORY_SEPARATOR . $path;
    }
